...
export async function action({ request }: any) {
  try {
    ...
    if (!admin) {
      return json(
        { success: false, error: "Unauthorized App Proxy Request" },
        { status: 401 },
      );
    }
        ...
        variables: {
          metaobject: {
            ...
            fields: [
              ...
              {
                key: "on_shopify",
                value: JSON.stringify(body.on_shopify === true),
              },
              {
                key: "affiliate_program",
                value: JSON.stringify(body.affiliate_program === true),
              },
              {
                key: "affiliate_link",
                value: String(body.affiliate_link || ""),
              },
              {
                key: "placements",
